...
const GraficoFerramentas = ({ disponiveis, emprestadas, manutencao }) => {
    const series = [disponiveis, emprestadas, manutencao]; // [Verde, Vermelho, Laranja]
    
    const options = {
        fill: { colors: ['#0BDD17', '#DD0B0B', '#FFA500'] },
        chart: { type: 'donut' },
